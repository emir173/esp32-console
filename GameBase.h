...
inline void osDrawPause(TFT_eSPI &gfx, uint16_t accent = TFT_YELLOW) {
    ...
    gfx.setCursor(menuX, 61);
    gfx.print("[A] Continue");
    gfx.setCursor(menuX, 71);
    gfx.print("[B] Game Menu");
    gfx.setCursor(menuX, 81);
    gfx.print("[C] OS Menu");
}
...
inline void osDrawGameOver(TFT_eSPI &gfx, bool win,
    ...
    gfx.setCursor(80 - gfx.textWidth(title) / 2, 12);
    gfx.print(title);
    ...
    if (count > 0) {
        ...
        int16_t rowH = 13;
        int16_t areaTop = 32;
        int16_t areaBot = badge ? 76 : 86;   // rozet varsa yer birak
    ...
    if (badge) {
        ...
        gfx.setCursor(80 - gfx.textWidth(badge) / 2, 78);
        gfx.print(badge);
    }
    ...
    gfx.setCursor(menuX, 90);
    gfx.print("[A] Play Again");
    gfx.setCursor(menuX, 100);
    gfx.print("[B] Game Menu");
    gfx.setCursor(menuX, 110);
    gfx.print("[C] OS Menu");
}
